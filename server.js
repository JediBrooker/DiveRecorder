...
// [SECTION: LIVE STATE]
// Both maps moved into lib/live-state.js so the socket engine
// (routes/socket.js) and the event-status flip handler in this
// file share the same in-memory references.
// =============================================================
